...
import 'package:gradecryptdesktop/csvgui.dart';
...
class _MainWindowState extends State<MainWindow>
  ...
  Uint8List? bytes;
  final cryptstring = TextEditingController();
    ...
    if (isChecked == false) {
      if (gradepointsmaxcontroller.text != "" ||
        ...
        try {
          ...
          cryptstring.text = stringToBase64.encode(QrData);
        } catch (e) {
          if (useCodeID) {
            QrData =
                  ...
                  children: [
                    ...
                    DropdownButton(
                        ...
                        onPressed: () {
                            Navigator.push(
                           context,
                          MaterialPageRoute(builder: (context) => const CSVGUI()),
                          );
                      ...
                      try {
                        ...
                        if (isChecked == true) {
                          ...
                          if (AverageGrade != null && Average.length > 1) {
                            AverageVisible = true;
                          } //so if the amount of entrys in average is greater than 1, we set AverageVisible to true. (Making the Average-stuff visible)
                        }
